...
if (have_posts()) {
    ...
    $atts['img_size'] = 'ever_list_thumb';
    $atts['media_bgimage'] = true;
    $atts['more_text'] = ever_option("readmore", "Read more");
    $ever_options['blog_layout'] = isset($ever_options['blog_layout']) ? $ever_options['blog_layout']:'list';
    $class = '';
    if($ever_options['blog_layout'] == 'list2' || $ever_options['blog_layout'] == 'list2-full'){
        $class = ' right-thumb';
    }

    echo '<div class="tw-blog list-blog'.esc_attr($class).'">';
